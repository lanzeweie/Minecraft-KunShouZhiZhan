...
execute as @p if score 剩余时间 play_start matches 9999 run title @a subtitle [{"text":"30min 额外空投","color":"yellow","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}]
...
execute as @p unless score 剩余时间 play_start matches ..0 run schedule function hanhankszz:pure_airdrop/pure_airdrop30min 1s
...
execute as @p if score 剩余时间 play_start matches 0 run scoreboard players set 剩余时间 worldtimeliushi 1800
...
execute as @p if score 剩余时间 play_start matches 0 run tellraw @a [{"text":"——————————当前版本 30分钟  额外空投————————————————","color":"white","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}]
...
execute as @p if score 剩余时间 play_start matches 0 run spreadplayers ~ ~ 600 1000 false @a
...
execute as @p if score 剩余时间 play_start matches 0 run schedule function hanhankszz:airboot_time/pure_airboot30min 270s
