...
execute as @p if score 剩余时间 play_start matches 0 run tellraw @a [{"text":"——————————当前版本 30分钟————————————————","color":"white","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}]
