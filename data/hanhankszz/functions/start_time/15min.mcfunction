...
execute as @p if score 剩余时间 play_start matches 9999 run title @a subtitle [{"text":"15min","color":"yellow","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}]
...
execute as @p unless score 剩余时间 play_start matches ..0 run schedule function hanhankszz:start_time/15min 1s
...
execute as @p if score 剩余时间 play_start matches 0 run scoreboard players set 剩余时间 worldtimeliushi 900
...
execute as @p if score 剩余时间 play_start matches 0 run tellraw @a [{"text":"——————————当前版本 15分钟————————————————","color":"white","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}]
...
execute as @p if score 剩余时间 play_start matches 0 run spreadplayers ~ ~ 400 900 false @a
...
execute as @p if score 剩余时间 play_start matches 0 run schedule function hanhankszz:airboot_time/airboot15min 300s
