...
execute as @p if score 剩余时间 play_start matches 9999 run title @a subtitle [{"text":"90min","color":"yellow","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}]
...
execute as @p unless score 剩余时间 play_start matches ..0 run schedule function hanhankszz:start_time/90min 1s
...
execute as @p if score 剩余时间 play_start matches 0 run scoreboard players set 剩余时间 worldtimeliushi 5400
...
execute as @p if score 剩余时间 play_start matches 0 run worldborder set 200 5400
...
execute as @p if score 剩余时间 play_start matches 0 if score 空投时间 player_airboot_time matches 0 run schedule function hanhankszz:airboot_time/airboot90min 800s
